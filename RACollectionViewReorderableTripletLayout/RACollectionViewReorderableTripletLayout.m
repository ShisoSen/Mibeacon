...
//        _doubleTapGesture = [[UITapGestureRecognizer alloc] initWithTarget:self action:@selector(handDoubleTapGesture:)];
...
- (void)handDoubleTapGesture:(UIPanGestureRecognizer *)doubleTap
{
//to-do
}
